...
export const COMMERCE_AI_SKILL_CATALOG: readonly CommerceAiSkillDefinition[] = [
  ...
  {
    id: "seo.category_content",
    domain: "seo",
    status: "active",
    title: "Category SEO content",
    description: "Write SEO intro texts for category pages using real product context.",
  },
  {
    ...
    description: "Recommend internal links from blog posts to products and categories.",
  },
  {
    id: "seo.fix_404",
    domain: "seo",
