      ...
      >
        <figure className="relative aspect-[4/5] overflow-hidden bg-ink">
          ...
          <figcaption className="absolute inset-x-0 bottom-0 z-10 p-5 sm:p-6">
            ...
            <h2 className="mt-3 font-body text-2xl font-bold normal-case leading-[1.05] tracking-normal text-paper transition-colors duration-200 group-hover:text-accent sm:text-3xl">
              {post.title}
            </h2>
          </figcaption>
        </figure>
    ...
    <article className="group">
      ...
      >
        ...
        <div className="flex flex-col justify-end gap-5 bg-moto p-6 sm:p-8 lg:col-span-5 lg:p-10 xl:p-12">
          ...
          <h2 className="font-body text-[clamp(1.65rem,3.6vw,2.5rem)] font-bold normal-case leading-[0.95] tracking-normal text-ink transition-colors duration-200 group-hover:text-accent">
            {post.title}
          </h2>
    ...
    <article className="group">
      ...
      >
        ...
        <div className="min-w-0 py-0.5">
          ...
          <h3 className="mt-2 font-body text-sm font-semibold normal-case leading-snug tracking-normal text-ink transition-colors group-hover:text-accent">
            {post.title}
          </h3>
        </div>
      </Link>
