...
export interface StarButtonProps extends ButtonHTMLAttributes<HTMLButtonElement> {
  children: ReactNode;
  lightWidth?: number;
  duration?: number;
  lightColor?: string;
...
export function StarButton({
  ...
  return (
    ...
    >
      ...
      />
      <div
        className="pointer-events-none absolute inset-0 z-[4] overflow-hidden rounded-[inherit] border-ink/10"
