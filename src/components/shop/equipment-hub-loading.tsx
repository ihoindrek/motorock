...
export function EquipmentHubLoading({ ariaLabel }: EquipmentHubLoadingProps) {
  return (
    <div className="bg-ink" aria-busy="true" aria-label={ariaLabel}>
