...
export const et: Dictionary = {
  ...
  checkout: {
    ...
    validateCoupon: "Aktiveeri",
    validatingCoupon: "Aktiveerin…",
    ...
    deliveryChecklistTitle: "Veel vaja",
    deliveryChecklistEmail: "Kehtiv e-posti aadress",
    deliveryChecklistCountry: "Tarneriik",
    deliveryChecklistShipping: "Tarneviis",
    deliveryChecklistPickup: "Pakiautomaat",
    deliveryChecklistAddress: "Tarneaadress",
    deliveryChecklistName: "Ees- ja perekonnanimi",
    deliveryChecklistPhone: "Kehtiv telefoninumber",
    fieldRequired: "See väli on kohustuslik.",
    emailInvalid: "Sisesta kehtiv e-posti aadress.",
    submitBlockTerms: "Jätkamiseks nõustu tingimustega.",
    submitBlockDelivery: "Esmalt täida tarneandmed.",
    submitBlockPayment: "Vali makseviis.",
    submitBlockMontonioBank: "Jätkamiseks vali pank.",
    ...
    orderOverview: "Tellimuse ülevaade",
    couponNotFound:
    ...
    paymentMethodsWooPayments: "Kaardimakse",
    paymentMethodsWooPaymentsDesc:
      "Visa, Mastercard ja teised kaardid.",
  ...
  pdp: {
    ...
    features: "Omadused",
    faq: "KKK",
    faqDescription: "Korduma kippuvad küsimused selle toote kohta",
    faqSupportPrefix: "Ei leidnud vastust? Võta ühendust",
    faqSupportLink: "klienditoega",
    oneSize: "Üks suurus",
    shippingReturnsBody:
      "Tarne üle EL-i SmartPosti, Omniva, DPD, kulleri või salongist kättesaamisega. Tasuta tarne alates 200 € tellimustele. 14-päevane taganemisõigus — kirjuta info@motorock.eu.",
    shippingFrom: "Tarne alates {price}",
    shippingFree: "Tasuta tarne",
    shippingFreeFromThreshold: "Tasuta tarne alates {amount} tellimustele",
    shippingFreeRemaining: "Lisa veel {amount} tasuta tarneks",
    shippingFreeUnlocked: "Tasuta tarne — tellimus katab läve",
    ...
    trustFreeShippingTitle: "Sellele tootele tarne tasuta!",
  ...
  giveaway: {
    ...
    giveaway2026ShortTitlePrefix: "Võida ",
